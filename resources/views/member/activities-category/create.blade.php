	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_content">
						<form class="form-horizontal form-label-left" action="{{ url('member/activities-category') }}" method="POST" novalidate>
							{!! csrf_field() !!}
							...
							<div class="item form-group">
								<div class="col-md-6 col-md-offset-3">
									<button id="send" type="submit" class="btn btn-success">เพิ่มประเภทกิจกรรม</button>
								</div>
							</div>
