...
var validator = (function(){
	...
	*/
	message = {
		...
		empty			: 'โปรดกรอกข้อมูล',
		min				: 'ข้อมูลน้อยเกินไป',
		max				: 'ข้อมูลยาวเกินไป',
		number_min		: 'จำนวนน้อยเกินไป',
		number_max		: 'จำนวนมากเกินไป',
		url				: 'URL ไม่ถูกต้อง',
		number			: 'โปรดใส่ตัวเลข',
		email			: 'อีเมลไม่ถูกต้อง',
		email_repeat	: 'อีเมลไม่ตรงกัน',
		password_repeat	: 'รหัสผ่านไม่ถูกต้อง',
		repeat			: 'ข้อมูลไม่ตรงกัน',
		complete		: 'input is not complete',
		select			: 'โปรดเลือกข้อมูล'
	};
